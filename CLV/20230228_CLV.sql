...
FROM  `bustling-psyche-375313.humana_oval_2023.20230207_Base_Reembolsos_Con_Pagos_vf` 
)
,reembolsos_agrup as(
...
select distinct u.*
,siniestralidad
from union_churn_clean u left join reembolsos_agrup r on mes_vigente=month_r and u.contrato=safe_cast(r.contrato as string)
)
