...
select distinct mes_vigente,producto_principal
,codigo_plan
--,tenure,segmentacion_cartera,segmentacion_cliente,rango_etario,genero_contratante
,calificacion_riesgo
,sucursal
