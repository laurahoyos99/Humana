...
when edad_actual_contratante between 24 and 29 then 'R.4-1 24 a 29 años'
when edad_actual_contratante between 30 and 35 then 'R.4-2 30 a 35 años'
...
,segmentacion_cartera,segmentacion_cliente
,rango_etario
,genero_contratante,calificacion_riesgo
