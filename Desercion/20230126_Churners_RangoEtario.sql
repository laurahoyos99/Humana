...
select distinct base_month--,clasificacion_contrato,provincia_contrato,ciudad_contrato, sucursal, producto_principal,codigo_plan,forma_pago_contrato,canal_venta,segmentacion_cartera--,
,rango_etario
,count(distinct contrato) as contratos, count(distinct churner) as churners
from clasificacion_etario
where producto_principal='PRACTIHUMANA'
